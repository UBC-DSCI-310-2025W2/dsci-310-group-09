...
all: results/online_shoppers_model_feature_importance.png
...
results/online_shoppers_eda_histograms.png: source/03_create_online_shoppers_eda.py data/processed_online_shoppers.csv
